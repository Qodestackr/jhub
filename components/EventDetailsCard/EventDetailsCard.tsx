      ...
      <div className="-my-4 divide-y divide-gray-200 dark:divide-gray-700">
        <div className="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            <a href="/" className="hover:underline">JHUB Opening remarks</a>
          </h3>
        </div>
        ...
        <div className="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            <a href="/" className="hover:underline">First Speaker: Talk, Sustainable Innovation in Tech</a>
          </h3>
        </div>
        ...
        <div className="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            <a href="/" className="hover:underline">Second Talk: A Collaborative Open Framework for Helping Small Farmers.</a>
          </h3>
        </div>
        ...
        <div className="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            <a href="/" className="hover:underline">Scaling your Brand With JHUB Consultancy Services</a>
          </h3>
        </div>
