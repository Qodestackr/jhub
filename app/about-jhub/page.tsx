...
export default function AboutJHUB() {
  return (
    <div>
      ...
      <p className="text-lg mb-4">
        JHUB stands out as a Digital Innovation Hub that goes beyond
        conventional boundaries. Here&apos;s what sets us apart:
      </p>
      <ul className="list-disc ml-6 mb-4">
        <li>
          Comprehensive Training Programs: Offering hands-on learning and
          practical experiences.
        </li>
        <li>
          Financial Support: Dedicated assistance in finding investments for
          digital initiatives.
        </li>
        <li>
          Forums for Collaboration: A vibrant community for discussions,
          knowledge sharing, and networking.
        </li>
        <li>
          Commitment to Sustainability: Integrating technology and
      ...
      <p className="text-lg mb-4">
        ...
        landscape. We aspire to be a hub where innovation meets sustainability,
        creating a ripple effect that transforms individuals, businesses, and
        communities.
      </p>
