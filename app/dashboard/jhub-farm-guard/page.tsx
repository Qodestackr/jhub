  ...
  return (
    <div className="container mx-auto p-8">
      <div className="text-2xl font-bold text-green-500 mb-8">
        Work In Progress for JHUB Guard Feature
        <br />
      ...
      <p className="text-lg mb-8">
        JHUB Guard™ is designed for simplicity. Speak to our consultants, order
        your JHUB Guard™, and we&apos;ll handle the rest. We deliver, install,
        and set up your cloud access, allowing you to manage your farm from our
        app, web portal, or even through a USSD platform.
      </p>
    </div>
  );
};

export default JHUBGuardPage;
